...
let div1p = titledivchild("p","id", "description", "Kindly fill the details given below:-");
...
let food_label1 = fooditemslabel("label", "for", "food", "BIRYANI");
let food_label2 = fooditemslabel("label", "for", "food", "NOODLES");
let food_label3 = fooditemslabel("label", "for", "food", "PIZZA");
let food_label4 = fooditemslabel("label","for", "food", "SHAWARMA");
let food_label5 = fooditemslabel("label","for","food","BBQ");
